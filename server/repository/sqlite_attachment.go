...
func (r *sqliteAttachmentRepo) Create(ctx context.Context, attachment *models.Attachment) error {
	query := `
		INSERT INTO attachments (id, message_id, filename, file_url, file_size, mime_type, thumb_url, thumb_width, thumb_height, thumb_size)
...
func (r *sqliteAttachmentRepo) GetByMessageID(ctx context.Context, messageID string) ([]models.Attachment, error) {
	query := `
		SELECT id, message_id, filename, file_url, file_size, mime_type, created_at, thumb_url, thumb_width, thumb_height, thumb_size
